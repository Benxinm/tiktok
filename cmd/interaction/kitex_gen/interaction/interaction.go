...
import (
	...
	"strings"
	"github.com/benxinm/tiktok/cmd/interaction/kitex_gen/user"
)
...
type UserTotalFavoritedResponse struct {
	Base           *BaseResp `thrift:"base,1" frugal:"1,default,BaseResp" json:"base"`
	TotalFavorited int64     `thrift:"total_favorited,2" frugal:"2,default,i64" json:"total_favorited"`
}
...
type IsFavoriteResponse struct {
	Base       *BaseResp `thrift:"base,1" frugal:"1,default,BaseResp" json:"base"`
	IsFavorite bool      `thrift:"is_favorite,2" frugal:"2,default,bool" json:"is_favorite"`
}
